...
const Card = ({data,trending,index,media_type }) => {
  ...
  return (
    <Link to={"/"+mediaType+"/"+data.id} className='w-full md:min-w-[230px] md:max-w-[230px] h-72 md:h-96 overflow-hidden block rounded relative hover:scale-105 transition-all'>
